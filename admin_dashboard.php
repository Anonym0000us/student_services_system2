  ...
  <div class="dashboard-container">
    ...
    <aside class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li><a href="grievance_reports.php"><i class="fas fa-exclamation-triangle"></i> Grievances</a></li>
    ...
    <main class="main-content">
      ...
      <section class="stats">
        ...
        <a href="power_admin_manage_grievances.php" class="stat-card">
          <i class="fas fa-exclamation-triangle"></i>
          <p>Grievances</p>
          <span><?php echo $grievanceCount; ?></span>
        </a>
        <a href="scholarships.php" class="stat-card">
          <i class="fas fa-graduation-cap"></i>
          <p>Scholarships</p>
          <span><?php echo $scholarshipCount; ?></span>
        </a>
        <a href="manage_grievances.php" class="stat-card">
                    <i class="fas fa-exclamation-triangle"></i>
                    <p>Grievances</p>
                    <span><?php echo $grievanceCount; ?></span>
                </a>
